...
class FilterController extends ControllerMVC {
  ...
  void listenForFields({String message}) async {
    fields.add(new Field.fromJSON({'id': '0', 'name': AppLocalization.of(context).all, 'selected': true}));
  ...
  Future<void> refreshFields() async {
    fields.clear();
    listenForFields(message: AppLocalization.of(context).addresses_refreshed_successfuly);
  }
