...
class NotificationController extends ControllerMVC {
  ...
  void listenForNotifications({String message}) async {
    ...
    stream.listen((model.Notification _notification) {
      ...
      setState(() {
        ...
        if(_notification.type == "App\\Notifications\\StatusChangedOrder") {
  ...
  Future<void> refreshNotifications() async {
    ...
    notifications.clear();
    listenForNotifications(message: AppLocalization.of(context).notifications_refreshed_successfuly);
  }
}
