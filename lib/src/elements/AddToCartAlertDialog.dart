...
class AddToCartAlertDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: new Text(AppLocalization.of(context).reset_cart),
      ...
      content: Column(
        ...
        children: <Widget>[
          Padding(
            ...
            child: Text(
              AppLocalization.of(context).you_must_add_products_of_the_same_markets_choose_one,
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 8),
                              Text(
                                AppLocalization.of(context).reset_your_cart_and_order_meals_form_this_market,
                                style: Theme.of(context).textTheme.caption,
                              ),
                            ],
                          ),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              SizedBox(height: 8),
                              Text(
                                AppLocalization.of(context).keep_your_old_meals_of_this_market,
                                style: Theme.of(context).textTheme.caption,
                              ),
                            ],
                          ),
      ...
      actions: <Widget>[
        ...
        FlatButton(
          child: new Text(AppLocalization.of(context).reset),
          onPressed: () {
            onPressed(newProduct, reset: true);
            Navigator.of(context).pop();
          },
        ...
        FlatButton(
          child: new Text(AppLocalization.of(context).close),
          onPressed: () {
            Navigator.of(context).pop();
          },
        ),
