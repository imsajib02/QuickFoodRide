...
//            contentPadding: EdgeInsets.symmetric(horizontal: 20),
            ...
            title: Row(
              children: <Widget>[
                ...
                SizedBox(width: 10),
                Text(
                  AppLocalization.of(context).add_delivery_address,
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: new TextFormField(
                        ...
                        decoration: getInputDecoration(hintText: AppLocalization.of(context).home_address, labelText: AppLocalization.of(context).description),
                    ...
                    Padding(
                      ...
                      child: new TextFormField(
                        style: TextStyle(color: Theme.of(context).hintColor),
                        keyboardType: TextInputType.text,
                        decoration: getInputDecoration(hintText: AppLocalization.of(context).hint_full_address, labelText: AppLocalization.of(context).full_address),
