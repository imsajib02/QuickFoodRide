          ...
          children: <Widget>[
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  MaterialButton(
                    ...
                    child: Text(
                      AppLocalization.of(context).clear,
            ...
            Expanded(
              child: ListView(
                ...
                children: <Widget>[
                  ExpansionTile(
                    title: Text(AppLocalization.of(context).delivery_or_pickup),
                    children: [
                      CheckboxListTile(
                        ...
                        title: Text(
                          AppLocalization.of(context).delivery,
                      ...
                      CheckboxListTile(
                        ...
                        title: Text(
                          AppLocalization.of(context).pickup,
                          overflow: TextOverflow.fade,
                          softWrap: false,
                          maxLines: 1,
                        ),
                  ...
                  ExpansionTile(
                    title: Text(AppLocalization.of(context).opened_markets),
                    children: [
                      CheckboxListTile(
                        controlAffinity: ListTileControlAffinity.trailing,
                        ...
                        title: Text(
                          AppLocalization.of(context).open,
                          overflow: TextOverflow.fade,
                          softWrap: false,
                          maxLines: 1,
                        ),
                  ...
                  _con.fields.isEmpty
                      ...
                      : ExpansionTile(
                          title: Text(AppLocalization.of(context).fields),
            ...
            FlatButton(
              ...
              shape: StadiumBorder(),
              child: Text(
                AppLocalization.of(context).apply_filters,
