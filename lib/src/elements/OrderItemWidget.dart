    ...
    return Stack(
      children: <Widget>[
              ...
              Container(
                ...
                child: Theme(
                  ...
                  child: ExpansionTile(
                    ...
                    title: Column(
                      children: <Widget>[
                        Text('${AppLocalization.of(context).order_id}: #${widget.order.id}'),
                        Text(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                Expanded(
                                  child: Text(
                                    '${AppLocalization.of(context).tax} (${widget.order.tax}%)',
                                    style: Theme.of(context).textTheme.bodyText1,
                                  ),
                                ),
                ...
                child: Wrap(
                  ...
                  children: <Widget>[
                    FlatButton(
                      ...
                      child: Wrap(
                        children: <Widget>[Text(AppLocalization.of(context).view)],
                      ),
                    ...
                    if (widget.order.canCancelOrder())
                      FlatButton(
                        ...
                        textColor: Theme.of(context).hintColor,
                        child: Wrap(
                          children: <Widget>[Text(AppLocalization.of(context).cancel + " ")],
                        ),
        ...
        Container(
          ...
          child: Text(
            widget.order.active ? '${widget.order.orderStatus.status}' : AppLocalization.of(context).canceled,
            maxLines: 1,
