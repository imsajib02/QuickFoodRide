...
//        },
  ...
  Future<bool> onWillPop() {
    ...
    if (currentBackPressTime == null || now.difference(currentBackPressTime) > Duration(seconds: 2)) {
      ...
      Fluttertoast.showToast(msg: AppLocalization.of(context).tapAgainToLeave);
  ...
  String trans(String text) {
    switch (text) {
      case "App\\Notifications\\StatusChangedOrder":
        return AppLocalization.of(context).order_status_changed;
      case "App\\Notifications\\NewOrder":
        return AppLocalization.of(context).new_order_from_client;
      case "km":
        return AppLocalization.of(context).km;
      case "mi":
        return AppLocalization.of(context).mi;
      default:
        return "";
    }
  }
