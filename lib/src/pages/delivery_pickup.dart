...
//      widget.delivery = widget.list.pickupList.elementAt(1);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text(
          AppLocalization.of(context).delivery_or_pickup,
          ...
          children: <Widget>[
            Padding(
              ...
              child: ListTile(
                ...
                subtitle: Text(
                  AppLocalization.of(context).pickup_your_product_from_the_market,
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                ...
                Padding(
                  ...
                  child: ListTile(
                    ...
                    subtitle: _con.carts.isNotEmpty && Helper.canDelivery(_con.carts[0].product.market, carts: _con.carts)
                        ? Text(
                            AppLocalization.of(context).click_to_confirm_your_address_and_pay_or_long_press,
                            maxLines: 3,
                            overflow: TextOverflow.ellipsis,
                            style: Theme.of(context).textTheme.caption,
                          )
                        : Text(
                            AppLocalization.of(context).deliveryMethodNotAllowed,
                            maxLines: 3,
                            overflow: TextOverflow.ellipsis,
                            style: Theme.of(context).textTheme.caption,
                          ),
