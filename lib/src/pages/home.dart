      ...
      appBar: AppBar(
        ...
        title: ValueListenableBuilder(
          ...
          builder: (context, value, child) {
            return Text(
              value.appName ?? AppLocalization.of(context).home,
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    AppLocalization.of(context).top_markets,
                    style: Theme.of(context).textTheme.headline4,
                  ),
                  subtitle: Text(
                    AppLocalization.of(context).near_to + " " + (settingsRepo.deliveryAddress.value?.address ?? AppLocalization.of(context).unknown),
              ...
              ListTile(
                ...
                title: Text(
                  AppLocalization.of(context).trending_this_week,
                  style: Theme.of(context).textTheme.headline4,
                ),
                subtitle: Text(
                  AppLocalization.of(context).clickOnTheProductToGetMoreDetailsAboutIt,
                  maxLines: 2,
                  style: Theme.of(context).textTheme.caption,
                ),
              ),
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    AppLocalization.of(context).product_categories,
                    style: Theme.of(context).textTheme.headline4,
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    AppLocalization.of(context).most_popular,
                    style: Theme.of(context).textTheme.headline4,
                  ),
                ),
              ),
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    AppLocalization.of(context).recent_reviews,
                    style: Theme.of(context).textTheme.headline4,
                  ),
                ),
              ),
