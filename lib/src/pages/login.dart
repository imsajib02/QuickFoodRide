          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                ...
                height: config.App(context).appHeight(37),
                child: Text(
                  AppLocalization.of(context).lets_start_with_login,
                    ...
                    children: <Widget>[
                      ...
                      FlatButton(
                        onPressed: () {
                          ...
                          if(Constants.shouldPopTwo) {

                            Constants.shouldPopTwo = false;
                        ...
                        child: Text(AppLocalization.of(context).skip),
              ...
              child: Column(
                children: <Widget>[
                  FlatButton(
                    ...
                    textColor: Theme.of(context).hintColor,
                    child: Text(AppLocalization.of(context).i_forgot_password),
                  ),
                  FlatButton(
                    onPressed: () {
