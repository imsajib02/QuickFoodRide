...
import 'package:gogrocify/src/controllers/user_controller.dart';
import 'package:gogrocify/src/helpers/helper.dart';
import 'package:gogrocify/src/models/otp_verify.dart';
          ...
          child: Column(
            ...
            children: <Widget>[
              SizedBox(
                ...
                child: Column(
                  children: <Widget>[
                    Text(AppLocalization.of(context).verify_number,
                      style: Theme.of(context).textTheme.headline5,
                      textAlign: TextAlign.center,
                    ),
                    SizedBox(height: 10),
                    Text(AppLocalization.of(context).otp_code_sent + "+88-" + widget.user.email,
              ...
              Form(
                ...
                child: TextFormField(
                  ...
                  validator: (input) => input.isEmpty ? AppLocalization.of(context).enterSentCode : input.length < 6 ? AppLocalization.of(context).codeShort : null,
                  style: Theme.of(context).textTheme.headline5,
                  textAlign: TextAlign.center,
              ...
              new BlockButtonWidget(
                ...
                text: Text(AppLocalization.of(context).verify.toUpperCase(),
