    ...
    return Scaffold(
      ...
      body: Builder(
        builder: (BuildContext context) {
          ...
          return _con.product == null || _con.product?.image == null
                              ...
                              child: Wrap(
                                ...
                                children: [
                                    ...
                                    children: <Widget>[
                                      Container(
                                        ...
                                        child: Helper.canDelivery(_con.product.market) && _con.product.deliverable
                                            ? Text(
                                          AppLocalization.of(context).deliverable,
                                          style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                        )
                                            : Text(
                                          AppLocalization.of(context).not_deliverable,
                                          style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                        ),
                                      ),
                                      ...
                                      Container(
                                          ...
                                          decoration: BoxDecoration(color: Theme.of(context).focusColor, borderRadius: BorderRadius.circular(24)),
                                          child: Text(
                                            _con.product.packageItemsCount + " " + AppLocalization.of(context).items,
                                            style: Theme.of(context).textTheme.caption.merge(TextStyle(color: Theme.of(context).primaryColor)),
                                          )),
                                    ],
                                  ),
                                  ...
                                  ListTile(
                                    ...
                                    title: Text(
                                      AppLocalization.of(context).options,
                                      style: Theme.of(context).textTheme.subtitle1,
                                    ),
                                    subtitle: Text(
                                      AppLocalization.of(context).select_options_to_add_them_on_the_product,
                                  ...
                                  ListTile(
                                    ...
                                    title: Text(
                                      AppLocalization.of(context).reviews,
                                      style: Theme.of(context).textTheme.subtitle1,
                                    ),
                                  ),
                                  ReviewsListWidget(
                            ...
                            children: <Widget>[
                              Row(
                                children: <Widget>[
                                  Expanded(
                                    child: Text(
                                      AppLocalization.of(context).quantity,
                                      style: Theme.of(context).textTheme.subtitle1,
                                    ),
                                  ),
                                  Row(
                                      ...
                                      SizedBox(
                                        ...
                                        child: FlatButton(
                                          onPressed: () {
                                            if (currentUser.value.apiToken == null) {
                                              ...
                                              if (_con.isSameMarkets(_con.product)) {
                                                ...
                                                if(Helper.canDelivery(_con.product.market) && _con.product.deliverable) {
                                                  _con.addToCart(_con.product);
                                                }
                                                else {
                                                  Scaffold.of(context).showSnackBar(SnackBar(
                                                    content: Text(AppLocalization.of(context).not_deliverable),
                                                  ));
                                                }
                                              } else {
                                                showDialog(
                                          ...
                                          child: Container(
                                            ...
                                            child: Text(
                                              AppLocalization.of(context).add_to_cart,
