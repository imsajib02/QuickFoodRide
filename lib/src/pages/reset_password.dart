...
import 'package:gogrocify/src/models/password.dart';
import 'package:gogrocify/src/models/user.dart';
          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                ...
                height: config.App(context).appHeight(37),
                child: Text(AppLocalization.of(context).reset + " " + AppLocalization.of(context).password,
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      TextFormField(
                        ...
                        validator: (input) => input.length < 6 ? AppLocalization.of(context).must_be_6_letters : null,
                        obscureText: _hidden1,
                        decoration: InputDecoration(
                          labelText: AppLocalization.of(context).new_password,
                      ...
                      TextFormField(
                        ...
                        keyboardType: TextInputType.text,
                        validator: (input) => input.length < 6 ? AppLocalization.of(context).must_be_6_letters : (input != _newController.text ?
                        AppLocalization.of(context).confirm_password_do_not_match : null),
                        obscureText: _hidden2,
                        decoration: InputDecoration(
                          labelText: AppLocalization.of(context).confirm_password,
                          labelStyle: TextStyle(color: Theme.of(context).accentColor),
                          contentPadding: EdgeInsets.all(12),
                          hintText: '••••••••••••',
                          hintStyle: TextStyle(color: Theme.of(context).focusColor.withOpacity(0.7)),
