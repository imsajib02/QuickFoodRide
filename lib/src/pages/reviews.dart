                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              Text(AppLocalization.of(context).how_would_you_rate_this_market_, textAlign: TextAlign.center, style: Theme.of(context).textTheme.subtitle1),
                              SizedBox(height: 10),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                              ...
                              TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: AppLocalization.of(context).tell_us_about_this_market,
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  TextField(
                                    ...
                                    decoration: InputDecoration(
                                      contentPadding: EdgeInsets.all(12),
                                      hintText: AppLocalization.of(context).tell_us_about_this_product,
                                      hintStyle: Theme.of(context).textTheme.caption.merge(TextStyle(fontSize: 14)),
                                      border: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
                                      focusedBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.2))),
                                      enabledBorder: OutlineInputBorder(borderSide: BorderSide(color: Theme.of(context).focusColor.withOpacity(0.1))),
