        ...
        bottomNavigationBar: Container(
          ...
          child: _con.order == null || _con.orderStatus.isEmpty
              ...
              : Column(
                  ...
                  children: <Widget>[
                    Text(AppLocalization.of(context).how_would_you_rate_this_market, style: Theme.of(context).textTheme.subtitle1),
                    Text(AppLocalization.of(context).click_on_the_stars_below_to_leave_comments, style: Theme.of(context).textTheme.caption),
                    SizedBox(height: 5),
                    FlatButton(
                      onPressed: () {
                        ...
                        Tab(
                          child: Container(
                            ...
                            child: Align(
                              ...
                              child: Text(AppLocalization.of(context).details),
                            ),
                          ),
                        ),
                        Tab(
                          child: Container(
                            ...
                            child: Align(
                              alignment: Alignment.center,
                              child: Text(AppLocalization.of(context).tracking_order),
                            ),
                          ),
                        ),
                      ]),
                        ...
                        child: Stack(
                          ...
                          children: <Widget>[
                                  ...
                                  Container(
                                    ...
                                    child: Theme(
                                      ...
                                      child: ExpansionTile(
                                        ...
                                        title: Column(
                                          children: <Widget>[
                                            Text('${AppLocalization.of(context).order_id}: #${_con.order.id}'),
                                            Text(
                                          ...
                                          Column(
                                            ...
                                            (indexProduct) {
                                              return ProductOrderItemWidget(
                                                  heroTag: 'my_order', order: _con.order, productOrder: _con.order.productOrders.elementAt(indexProduct));
                                            },
                                          )),
                                          Padding(
                                              ...
                                              children: <Widget>[
                                                Row(
                                                  children: <Widget>[
                                                    Expanded(
                                                      child: Text(
                                                        AppLocalization.of(context).delivery_fee,
                                                ...
                                                Row(
                                                  children: <Widget>[
                                                    Expanded(
                                                      child: Text(
                                                        '${AppLocalization.of(context).tax} (${_con.order.tax}%)',
                                                        style: Theme.of(context).textTheme.bodyText1,
                                                      ),
                                                    ),
                                      ...
                                      children: <Widget>[
                                        if (_con.order.canCancelOrder())
                                          FlatButton(
                                              ...
                                              showDialog(
                                                ...
                                                builder: (BuildContext context) {
                                                  ...
                                                  return AlertDialog(
                                                    ...
                                                    content: Text(AppLocalization.of(context).areYouSureYouWantToCancelThisOrder),
                                            ...
                                            child: Wrap(
                                              children: <Widget>[Text(AppLocalization.of(context).cancelOrder + " ", style: TextStyle(height: 1.3)), Icon(Icons.clear)],
                                            ),
                                            padding: EdgeInsets.symmetric(horizontal: 20),
                                          ),
                                      ],
                            ...
                            Container(
                              ...
                              child: Text(
                                _con.order.active ? '${_con.order.orderStatus.status}' : AppLocalization.of(context).canceled,
                                maxLines: 1,
                                      ...
                                      Flexible(
                                        child: Column(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Text(
                                              _con.order.deliveryAddress?.address ?? AppLocalization.of(context).unknown,
